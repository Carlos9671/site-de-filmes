...
<head>
    ...
    <title>MyCine - Editar Gênero</title>
...
<body class="bg-slate-950 text-white min-h-screen">
    ...
    <div class="max-w-md mx-auto py-10 px-6">
        <h1 class="text-2xl font-bold text-violet-400 mb-8">Editar Gênero</h1>

        <form action="/generos/{{ $genero->id }}" method="POST" class="flex flex-col gap-6">
            @csrf
            @method('PUT')
